###################################################################################
# Title: BC_parallel.py

# Purpose: Preprocess and Bias Correct ERA5 data and CMIP6 data: Regrid, Spatial and temporal selection, change calendar, and save to netCDF files.
...
output_file = '/climca/people/onennecke/debiased_data/ERA5_hist_rsds.nc'
if os.path.isfile(output_file) == False:
    ERA5_ssrd.to_netcdf(output_file) 
# ERA5_ssrd
ERA5_sfcWind = ERA5_ds['sfcWind']
# Save ERA5 data to a netCDF file
output_file = '/climca/people/onennecke/debiased_data/ERA5_hist_sfcWind.nc'
if os.path.isfile(output_file) == False:
    ERA5_sfcWind.to_netcdf(output_file)
# ERA5_sfcWind
ERA5_tas = ERA5_ds['tas']
# Save ERA5 data to a netCDF file
output_file = '/climca/people/onennecke/debiased_data/ERA5_hist_tas.nc'
if os.path.isfile(output_file) == False:
    ERA5_tas.to_netcdf(output_file)
# ERA5_tas
ERA5_tasmax = ERA5_ds['tasmax']
# Save ERA5 data to a netCDF file
output_file = '/climca/people/onennecke/debiased_data/ERA5_hist_tasmax.nc'
if os.path.isfile(output_file) == False:
...
# Save ERA5 data to a netCDF file
output_file = '/climca/people/onennecke/debiased_data/ERA5_hist_psl.nc'
if os.path.isfile(output_file) == False:
...
def one_run(i):
    ...
    for var in variables:
        ...
        if os.path.isfile( output_file ) == False:
            ...
            if var == 'sfcWind':
                nc_ref = wind_model_func._wind_scale(nc_ref, 100, alpha_mask['mask'], 10)
